...
class GitHubAPI(plug.API):
    ...
    def get_teams(self) -> List[plug.Team]:
        """See :py:meth:`repobee_plug.APISpec.get_teams`."""
        return [
            plug.Team(
                name=t.name,
    ...
    def delete_teams(self, team_names: Iterable[str]) -> None:
        """See :py:func:`repobee_plug.APISpec.delete_teams`."""
    ...
    def ensure_teams_and_members(
        ...
        """See :py:func:`repobee_plug.APISpec.ensure_teams_and_members`."""
    ...
    def create_repos(self, repos: Iterable[plug.Repo]):
        """See :py:func:`repobee_plug.APISpec.create_repos`."""
        repo_urls = []
        for info in repos:
            created = False
    ...
    def get_repo_urls(
        ...
        """See :py:func:`repobee_plug.APISpec.get_repo_urls`."""
        with _try_api_request():
            org = (
                self._org
                if not org_name
    ...
    def extract_repo_name(self, repo_url: str) -> str:
        """See :py:func:`plug.APISpec.extract_repo_names`."""
    ...
    def get_issues(
        ...
        """See :py:func:`repobee_plug.APISpec.get_issues`."""
    ...
    def open_issue(
        ...
        """See :py:func:`repobee_plug.APISpec.open_issue`."""
    ...
    def close_issue(self, title_regex: str, repo_names: Iterable[str]) -> None:
        """See :py:func:`repobee_plug.APISpec.close_issue`."""
        repo_names_set = set(repo_names)
        repos = list(self._get_repos_by_name(repo_names_set))
    ...
    def add_repos_to_review_teams(
        ...
        """See :py:func:`repobee_plug.APISpec.add_repos_to_review_teams`.
        """
    ...
    def get_review_progress(
        ...
        """See :py:func:`repobee_plug.APISpec.get_review_progress`."""
    ...
    def verify_settings(
        ...
        """See :py:func:`repobee_plug.APISpec.verify_settings`."""
