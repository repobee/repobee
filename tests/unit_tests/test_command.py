...
def api_mock(request, mocker):
    ...
    mock = MagicMock(spec=repobee.ext.github_api.GitHubAPI)
    api_class = mocker.patch("repobee.ext.github_api.GitHubAPI", autospec=True)
    ...
    mock.get_issues = MagicMock(
        spec="repobee.ext.github_api.GitHubAPI.get_issues",
